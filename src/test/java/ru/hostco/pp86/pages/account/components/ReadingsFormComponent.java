...
public class ReadingsFormComponent {
    ...
    public ReadingsFormComponent setTemperature(double temperature) {
        $$("p-dialog .ui-g").findBy(text(Indicators.TEMPERATURE.text())).$("input").setValue(String.valueOf(temperature));
        return this;
    }

    @Step("Set body weight")
    public ReadingsFormComponent setWeight(double weight) {
        $$("p-dialog .ui-g").findBy(text(Indicators.WEIGHT.text())).$("input").setValue(String.valueOf(weight));
        return this;
    }

    @Step("Set blood pressure")
    public ReadingsFormComponent setPressure(int maxPressure, int minPressure) {
        $$("p-dialog .ui-g").findBy(text(Indicators.PRESSURE.text())).$("input")
    ...
    public ReadingsFormComponent setSugarLevel(double sugarLevel) {
        $$("p-dialog .ui-g").findBy(text(Indicators.SUGAR_LEVEL.text())).$("input").setValue(String.valueOf(sugarLevel));
        return this;
    }

    @Step("Set pulse level")
    public ReadingsFormComponent setPulse(int pulse) {
        $$("p-dialog .ui-g").findBy(text(Indicators.PULSE.text())).$("input").setValue(String.valueOf(pulse));
        return this;
    }

    @Step("Set mood description")
    public ReadingsFormComponent setMood(String mood) {
        $$("p-dialog .ui-g").findBy(text(Indicators.MOOD.text())).$("textarea").setValue(mood);
        return this;
    }

    @Step("Set alcohol level in blood")
    public ReadingsFormComponent setAlcohol(double alcohol) {
        $$("p-dialog .ui-g").findBy(text(Indicators.ALCOHOL.text())).$("input").setValue(String.valueOf(alcohol));
        return this;
    }

    @Step("Set ambivalence percent")
    public ReadingsFormComponent setAmbivalence(int ambivalence) {
        $$("p-dialog .ui-g").findBy(text(Indicators.AMBIVALENCE.text())).$("input").setValue(String.valueOf(ambivalence));
        return this;
    }

    @Step("Set health status description")
    public ReadingsFormComponent setHealthStatus(String healthStatus) {
        $$("p-dialog .ui-g").findBy(text(Indicators.HEALTH_STATUS.text())).$("textarea").setValue(healthStatus);
        return this;
    }

    @Step("Set skin condition description")
    public ReadingsFormComponent setSkinCondition(String skinCondition) {
        $$("p-dialog .ui-g").findBy(text(Indicators.SKIN_CONDITION.text())).$("textarea").setValue(skinCondition);
        return this;
    }
